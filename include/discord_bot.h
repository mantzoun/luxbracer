...
#ifndef INCLUDE_DISCORD_BOT_H_
#define INCLUDE_DISCORD_BOT_H_
...
class DiscordBot : public DiscordPostman {
 ...
 public:
  ...
  void add_planet_channel(const std::string & planet_name,
  ...
  dpp_event_t user_get_guilds_callback(dpp_cb_t value);
  dpp_event_t channels_get_callback(dpp_cb_t value);
  dpp_event_t delete_global_commands(dpp_cb_t value);
  dpp_event_t update_guild_commands(dpp_cb_t value);
  dpp_event_t channels_create_cb(dpp_cb_t value);
};
}  // namespace luxbracer

#endif  // INCLUDE_DISCORD_BOT_H_
