 ...
 */
#ifndef INCLUDE_LUX_TYPES_H_
#define INCLUDE_LUX_TYPES_H_
...
typedef dpp::command_completion_event_t dpp_event_t;
typedef dpp::confirmation_callback_t dpp_cb_t;
